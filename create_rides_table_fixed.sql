...
-- Admin policies (simplified - allow all authenticated users to view all rides for now)
...
('your-user-id-here', 'Nairobi CBD', 'Westlands', 'Standard', NULL, 300.00, 'pending', 'mpesa'),
('your-user-id-here', 'Kileleshwa', 'Kilimani', 'Economy', NULL, 400.00, 'confirmed', 'ewallet'),
('your-user-id-here', 'Lavington', 'Karen', 'Executive', NULL, 800.00, 'completed', 'mpesa');
*/
