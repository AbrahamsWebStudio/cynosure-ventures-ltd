  ...
  return (
    <>
      <main className="max-w-4xl mx-auto p-4 space-y-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-center dark:text-white">Completed Orders</h1>
        {/* Filter */}
        ...
        {/* Export Buttons */}
        <div className="flex gap-2">
          <Button onClick={() => exportToCSV(orders as unknown as { [key: string]: string | number | boolean | null | undefined }[], 'completed_orders_export')}>Export CSV</Button>
          <Button onClick={() => exportToExcel(orders as unknown as { [key: string]: string | number | boolean | null | undefined }[], 'completed_orders_export')}>Export Excel</Button>
        </div>
        {/* Orders Table */}
